...
GlRect::GlRect(std::string& id, std::array<float, 2>pos, std::array<float, 4>color, std::array<float, 2>size) 
...
std::vector<float> GlRect::createVertecies(std::array<float, 2>size) {
